...
import HomeCategoriesName from '../RestaurantMenuCustom/HomeCategories/HomeCategoriesName/HomeCategoriesName'
  ...
  return (
    <div className='max-w-5xl mx-auto' id='restaurantEntryContain'>
      ...
      <MenuProduct
        ...
        setVisibleSubcategoryId={setVisibleSubcategoryId}
        restaurantData={restaurantData}
        router={router}
      />
