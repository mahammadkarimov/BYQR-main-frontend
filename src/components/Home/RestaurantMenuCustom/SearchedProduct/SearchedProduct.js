    ...
    return (
        <div className='ml-4 mr-4 my-4 h-auto'>
            {searchedMeals?.data?.results?.map((meal) => (
                meal?.is_active ?
                    <div key={meal?.slug} className={styles.productCard} onClick={() => router.push(`${pathname}/${meal?.slug}`)} >
                    ...
                    <div className='relative'>
                        <div className={`${styles.productCard} ${styles.deactiveProductCard}`} onClick={() => router.push(`${pathname}/${meal?.slug}`)} >
                            <div className={styles.productCardLeft}>
