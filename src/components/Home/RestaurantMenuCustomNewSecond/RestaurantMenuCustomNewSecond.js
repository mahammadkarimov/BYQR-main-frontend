...
import HomeCategoriesName from '../HomeCategoriesCustomNew/HomeCategoriesName/HomeCategoriesName'
...
const RestaurantMenuCustomNewSecond = ({ t, searchParams, router, pathname, restaurantData, searchedMeals, setSearchedMeal, searchedMeal }) => {
    ...
    return (
        <div className='max-w-5xl mx-auto' style={{backgroundColor:"#F2F2F2"}}>
...
export default RestaurantMenuCustomNewSecond