...
import instanew from '../../../../assets/icons/Home/instanew.svg'
import wpnew from '../../../../assets/icons/Home/wpnew.svg'
import facenew from '../../../../assets/icons/Home/facenew.svg'
import copynew from '../../../../assets/icons/Home/copynew.svg'
import tiktoknew from '../../../../assets/icons/Home/tiktoknew.svg'
import Link from 'next/link'
import SuccessModal from '../../RestaurantMenu/SuccessModal/SuccessModal'

const SocialAreaCustomNew = ({ allData }) => {
            ...
            <div className='pt-[44px] pb-[74px] flex gap-[14px] justify-center' id='socialAreaBtn'>
                {
                    ...
                    <Link target='_blank' href={allData?.data?.whatsapp}>
                        <Image width={26} height={26} src={wpnew} alt='whatsapp' />
                    </Link>
                }
                {
                    allData?.data?.instagram &&
                    <Link target='_blank' href={allData?.data?.instagram}>
                        <Image width={26} height={26} src={instanew} alt='instagram' />
                    </Link>
                }
                {
                    allData?.data?.tiktok &&
                    <Link target='_blank' href={allData?.data?.tiktok}>
                        <Image width={26} height={26} src={tiktoknew} alt='tiktok' />
                    </Link>
                }
                {
                    allData?.data?.facebook &&
                    <Link target='_blank' href={allData?.data?.facebook}>
                        <Image width={26} height={26} src={facenew} alt='facebook' />
                    </Link>
                }
                <button onClick={copyUrlToClipboard}>
                    <div className='p-1 rounded-full'>
                        <Image width={26} height={26} src={copynew} alt='link' />
                    </div>
                </button>
            </div>
...
export default SocialAreaCustomNew