...
import HomeCategoriesName from '../HomeCategoriesCustom/HomeCategoriesName/HomeCategoriesName'
...
const RestaurantMenuCustomNew = ({ t, searchParams, router, pathname, restaurantData, searchedMeals, setSearchedMeal, searchedMeal }) => {
    ...
    return (
        <div className='max-w-5xl mx-auto' id='restaurantEntryContainCustom'>
...
export default RestaurantMenuCustomNew