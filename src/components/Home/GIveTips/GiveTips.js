...
import { handleService } from '@/redux/features/tipSlice'
import { useTranslations } from 'next-intl'
import styles from './callservice.module.css'
import Image from 'next/image'
import bagOfCoins from '../../../assets/icons/Home/bagOfCoins.png'
    ...
    <>
      ...
      >
        <motion.div style={{ height: isMaxH600 ? heightIconY600 : heightIcon }}>
          <Image src={bagOfCoins} width={44} height={42} alt="call-service" />
        </motion.div>
        <p className={styles.callServiceText}>{t('Tips')}</p>
      </motion.button>
    </>
  )
}
