...
import { MealCategoryList, MealSubCategoryCreate } from '@/services/api/dataApi'
...
const Page = () => {
  ...
  const mutation = useMutation((data) => MealSubCategoryCreate(data), {
    onSuccess: (response) => {
  ...
  const handleSubmit = (event) => {
    ...
    mutation.mutate({
      ...
      main_category_slug: mainCategoryName,
    })
  }
                ...
                >
                  <div className="form-row">
                    ...
                    <div className="mb-4">
                      ...
                      >
                        {mealMainCategoryData?.data?.map((mainCategory) => (
