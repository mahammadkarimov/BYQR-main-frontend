...
import { CreateHotelService, MealCategoryCreate } from "@/services/api/dataApi";
...
const Page = () => {
  ...
  // const mutation = useMutation((data) => CreateHotelService(data), {
  //   onSuccess: (response) => {
  //     console.log("success", response);
  //     queryClient.invalidateQueries(['service'])
  //     router.push(`/${pathname.slice(1, 3)}/admin/technical-services?panel=hotel`)
  //   },
  //   onError: (error) => {
  //     console.error(error);
                ...
                >
                  <div className="form-row">
                    <div className="col-md-12 mb-12">
                      <label htmlFor="validationCustom18">{t('Service Name')}</label>
